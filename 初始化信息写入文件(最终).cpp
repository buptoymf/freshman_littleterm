...
main()
{
	...
	fputs(ScenicSpotList[num3].ScenicSpot_ID,fp3);
	fputs("\n",fp3);
	fputs(ScenicSpotList[num3].ScenicSpot_NAME,fp3);
	fputs("\n",fp3);
	fputs(ScenicSpotList[num3].ScenicSpot_INTRO,fp3);
	fputs("\n",fp3);
	...
	fputs(ScenicSpotList[num3].ScenicSpot_TIME,fp3);
	fputs("\n",fp3);
	...
	fputs(ScenicSpotList[num3].ScenicSpot_GRADE,fp3);
	fputs("\n",fp3);
	fputs(ScenicSpotList[num3].ScenicSpot_NUMBER,fp3);
	fputs("\n",fp3);
	fputs(ScenicSpotList[num3].ScenicSpot_AREA,fp3);
	fputs("\n",fp3);
	...
	fputs(tmp,fp3);
	fputs("\n",fp3);
	fputs(ScenicSpotList[num3].ScenicSpot_LRET,fp3);
	fputs("\n",fp3);
