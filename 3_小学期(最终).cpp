...
void yudingliangpaixu()
{
   ...
   fp=fopen("景点信息.txt","rb");//打开文件“景点信息” 
    ...
    fp2=fopen("youke001的订单信息.txt","rb");//打开文件订单信息 
    int i2;//i2为订单个数 
...
void deleteinfo()
{
	FILE *pf = fopen("youke001的订单信息.txt", "rb");
...
/*			if(y==19*(a-1)+1)
   ...
   int piaoshu;
    ...
    FILE *pf2 = fopen("youke001的订单信息.txt", "rb");
...
/*		while(fgets(buf2,1000,jingdian))
    ...
    remove("youke001的订单信息.txt");
    rename("tmp.txt","youke001的订单信息.txt");
...
{ 
	...
	//引入文件中景点数据,计算景点个数 ,i是景点个数 
	  fp2=fopen("youke001的订单信息.txt","rb");
