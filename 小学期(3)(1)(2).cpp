...
void inputinfo()
{
	...
	int a,b,c,d,f,g,h,j,k,l,t;//判断各项信息输入是否正确的标记值 
	...
	for(i=0;i<n;i++)
	{
		...
		x=0;
		for(x=0;fread(&ScenicSpotList[x],sizeof(struct  ScenicSpot),1,fp)==1;x++)
        t=x;
		...
		fwrite(&ScenicSpotList,sizeof(ScenicSpot),i,jingdian2);
