...
struct  ScenicSpot
{
	...
	int ScenicSpot_PRICE1[80];//景点旺季门票价格
	int ScenicSpot_PRICE2[80];//景点淡季门票价格
	char ScenicSpot_TIME[80];//游览该景点所需时间
	float ScenicSpot_DISCOUNT[80];//折扣信息
...
void spotsystem()
{
	...
	strcpy(ScenicSpotList[num3].ScenicSpot_PRICE1,"200元");//景点旺季门票价格 
	strcpy(ScenicSpotList[num3].ScenicSpot_PRICE2,"140元");//景点淡季门票价格 
	strcpy(ScenicSpotList[num3].ScenicSpot_TIME,"4小时");//游览所需时间 
	strcpy(ScenicSpotList[num3].ScenicSpot_DISCOUNT,"8.8折");//折扣信息 
	...
	strcpy(ScenicSpotList[num3].ScenicSpot_PRICE1,"350元");//景点旺季门票价格 
	strcpy(ScenicSpotList[num3].ScenicSpot_PRICE2,"300元");//景点淡季门票价格 
	strcpy(ScenicSpotList[num3].ScenicSpot_TIME,"2.5小时");//游览所需时间 
	strcpy(ScenicSpotList[num3].ScenicSpot_DISCOUNT,"无");//折扣信息 
	strcpy(ScenicSpotList[num3].ScenicSpot_GRADE,"5级");//景点级别 
	strcpy(ScenicSpotList[num3].ScenicSpot_NUMBER,"无");//景点人数限制 
	...
	strcpy(ScenicSpotList[num3].ScenicSpot_PRICE1,"100元");//景点旺季门票价格 
	strcpy(ScenicSpotList[num3].ScenicSpot_PRICE2,"50元");//景点淡季门票价格 
	strcpy(ScenicSpotList[num3].ScenicSpot_TIME,"3.5小时");//游览所需时间 
	strcpy(ScenicSpotList[num3].ScenicSpot_DISCOUNT,"8折");//折扣信息 
	strcpy(ScenicSpotList[num3].ScenicSpot_GRADE,"5级");//景点级别 
	...
	strcpy(ScenicSpotList[num3].ScenicSpot_PRICE1,"230元");//景点旺季门票价格 
	strcpy(ScenicSpotList[num3].ScenicSpot_PRICE2,"170元");//景点淡季门票价格 
	...
	strcpy(ScenicSpotList[num3].ScenicSpot_DISCOUNT,"7.5折");//折扣信息 
	...
	strcpy(ScenicSpotList[num3].ScenicSpot_PRICE1,"225元");//景点旺季门票价格 
	strcpy(ScenicSpotList[num3].ScenicSpot_PRICE2,"175元");//景点淡季门票价格 
	strcpy(ScenicSpotList[num3].ScenicSpot_TIME,"3.5小时");//游览所需时间 
	strcpy(ScenicSpotList[num3].ScenicSpot_DISCOUNT,"7折");//折扣信息 
	strcpy(ScenicSpotList[num3].ScenicSpot_GRADE,"4级");//景点级别 
	...
	strcpy(ScenicSpotList[num3].ScenicSpot_PRICE1,"240元");//景点旺季门票价格 
	strcpy(ScenicSpotList[num3].ScenicSpot_PRICE2,"200元");//景点淡季门票价格 
	strcpy(ScenicSpotList[num3].ScenicSpot_TIME,"2.6小时");//游览所需时间 
	strcpy(ScenicSpotList[num3].ScenicSpot_DISCOUNT,"7.5折");//折扣信息 
	strcpy(ScenicSpotList[num3].ScenicSpot_GRADE,"4级");//景点级别 
	strcpy(ScenicSpotList[num3].ScenicSpot_NUMBER,"1.5万");//景点人数限制 
	strcpy(ScenicSpotList[num3].ScenicSpot_AREA,"长江");//景点所属区域 
	strcpy(ScenicSpotList[num3].ScenicSpot_COST,"");//景点维护费用
	num3++;
	//8号景点
	...
	strcpy(ScenicSpotList[num3].ScenicSpot_PRICE1,"260元");//景点旺季门票价格 
	strcpy(ScenicSpotList[num3].ScenicSpot_PRICE2,"210元");//景点淡季门票价格 
	strcpy(ScenicSpotList[num3].ScenicSpot_TIME,"1.5小时");//游览所需时间 
	strcpy(ScenicSpotList[num3].ScenicSpot_DISCOUNT,"6.5折");//折扣信息 
	strcpy(ScenicSpotList[num3].ScenicSpot_GRADE,"4级");//景点级别 
